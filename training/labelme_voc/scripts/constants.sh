...
DATASET_URL="https://drive.google.com/uc?id=1iBSxX7I0nFDJfYNpFEb1caSQ0nl4EVUa"
DATASET_TGZ="kitchen_dataset.tgz"
...
OBJ_DET_DIR="${RESEARCH_DIR}/scripts"
LEARN_DIR="${RESEARCH_DIR}/learn"
